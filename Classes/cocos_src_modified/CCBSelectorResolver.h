...
class CC_DLL CCBSelectorResolver {
    ...
    virtual cocos2d::SEL_MenuHandler onResolveCCBCCMenuItemSelectorPassSender(cocos2d::Ref * pTarget, const char* pSelectorName, cocos2d::Ref* sender) {return nullptr; }
